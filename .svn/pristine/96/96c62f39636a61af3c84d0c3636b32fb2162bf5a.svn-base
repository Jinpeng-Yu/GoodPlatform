    ...
    <div class="login_container">
      <div class="login_box">
        ...
        <el-form :model="loginForm" label-width="0px" :rules="loginFormRules" class="login_form">
          ...
          <tr>
            <el-link style="float: left;font-size: 18px" target="_blank" @click="getForget">忘记密码</el-link>
            <el-link style="float: left;margin-left: 500px;font-size: 18px" target="_blank" @click="getRegister">注册</el-link>
          </tr>
          <el-form-item class="btn_s">
            <el-button type="primary" style="font-size: 18px" @click="login">登录</el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
