...
public class SellerController {
    ...
    @RequestMapping(value = ConstUtils.URL_GET_ORDER_BY_ORDER_ID, method = RequestMethod.GET)
    public BaseResult<Object> getOrderByOrderId(@RequestParam("orderId") Integer OrderId) {
        BaseResult<Object> result = new BaseResult<>();
        sellerService.getOrderByOrderId(OrderId, result);
        return result;
    }

    @RequestMapping(value = ConstUtils.URL_GET_ORDER_INFO_BY_ORDER_ID, method = RequestMethod.GET)
    public BaseResult<Object> getOrderInfoByOrderId(@RequestParam("orderId") Integer orderId) {
        BaseResult<Object> result = new BaseResult<>();
        sellerService.getOrderInfoByOrderId(orderId, result);
        return result;
    }

    @RequestMapping(value = ConstUtils.URL_SEND_GOOD, method = RequestMethod.GET)
    public BaseResult<Object> sendGood(@RequestParam("orderId") Integer OrderId) {
        BaseResult<Object> result = new BaseResult<>();
        sellerService.sendGoodByOrderId(OrderId, result);
        return result;
    }

    @RequestMapping(value = ConstUtils.URL_GET_ADDRESS_BY_ORDER_ID, method = RequestMethod.GET)
    public BaseResult<Object> getAddressByOrderId(@RequestParam("orderId") Integer orderId) {
        BaseResult<Object> result = new BaseResult<>();
        sellerService.getAddressByOrderId(orderId, result);
        return result;
    }
}
